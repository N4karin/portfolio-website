    ...
    return (
        <div className="pb-10">
            ...
            <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-16 pb-6">
                {[
                    { src: "/projectimages/project3.png", name: "nakar.in", technologies: "Python, Django", link:"https://nakar.in", source:"https://github.com/N4karin/music-webpage", alt: "MusicPage", description: "My personal website showcasing current and past music projects, software/tools used and a comprehensive library of my discography." },
