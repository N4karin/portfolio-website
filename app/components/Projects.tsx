    ...
    return (
        <div className="pb-10">
            ...
            <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-16 pb-6">
                {[
                    { src: "/projectimages/project1.jpg", name: "nakarin.cc", technologies: "Vite, React, Contentful", link:"https://nakarin.cc", source:"https://github.com/N4karin/music-webpage", alt: "MusicPage", description: "My personal website showcasing my music projects, software/tools used and a blog. Created to learn how to using headless CMS in webpages work." },
                    { src: "/projectimages/project2.jpg", name: "VR Open Text Input", technologies: "C#, Unity", link:"https://github.com/N4karin/vr-open-text-input", source:"https://github.com/N4karin/vr-open-text-input", alt: "VRProject", description: "A set of 3 modular input methods to use with the Unity Game engine. Result of my Bachelor Thesis, researching whether mimicking real-life input methods in VR is the most user-friendly." },
